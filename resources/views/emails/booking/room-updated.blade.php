<x-emails.layouts.base
    title="Informasi Perubahan Pemesanan Ruang Meeting"
    accentColor="#fd7e14"
>
    ...
    <p style="margin:0 0 20px; font-size:15px; color:#343a40; line-height:1.6;">
        Kami menginformasikan bahwa pemesanan ruang meeting Anda telah <strong>diperbarui</strong>. Berikut detail terbaru:
    </p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-bottom:24px; border-radius:6px; overflow:hidden; border: 1px solid #dee2e6;">
        <tr style="background-color:#f8f9fa;">
            <td style="padding:12px 16px; font-size:13px; font-weight:700; color:#495057; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #dee2e6;" colspan="2">Detail Pemesanan (Terbaru)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="padding:12px 16px; font-size:14px; color:#212529; font-weight:600; border-bottom:1px solid #f1f3f5;">{{ $booking->description ?? '-' }}</td>
        </tr>
        @if($booking->guest_emails && count($booking->guest_emails) > 0)
        <tr style="background-color:#fafafa;">
        ...
        <tr>
            <td style="padding:14px 16px;">
                ...
                <p style="margin:6px 0 0; font-size:13px; color:#856404; line-height:1.6;">
                    Harap catat perubahan jadwal di atas. Jika ada pertanyaan atau keberatan, segera hubungi pemohon atau General Services.
                </p>
            </td>
        </tr>
    </table>
