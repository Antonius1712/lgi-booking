<x-emails.layouts.base
    title="Konfirmasi Pemesanan Ruang Meeting anda berakhir!"
    accentColor="#fd7e14"
>
    ...
    <p style="margin:0 0 20px; font-size:15px; color:#343a40; line-height:1.6;">
        Kami informasikan bahwa pemesanan ruang meeting Anda telah <strong>berakhir</strong>.
    </p>
    ...
    <p style="margin:0 0 20px; font-size:14px; color:#343a40; line-height:1.6; text-align:center;">
        Terima kasih telah melakukan pemesanan ini! Mohon kesediaannya memberikan kesan dan pesan Anda.
    </p>
