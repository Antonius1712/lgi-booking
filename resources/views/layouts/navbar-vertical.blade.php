<ul class="menu-inner">
    <li class="menu-item {{ request()->segment(1) === 'booking' ? 'active open' : null }}">
        ...
        <ul class="menu-sub">
            <li class="menu-item {{ request()->segment(2) === 'meeting-room' ? 'active' : null }}">
            ...
            <li class="menu-item {{ request()->segment(2) === 'driver' ? 'active' : null }}">
    ...
    <li class="menu-item {{ request()->segment(1) === 'admin' ? 'active open' : null }}">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
            <li class="menu-item {{ request()->segment(2) === 'locations' ? 'active' : null }}">
            ...
            <li class="menu-item {{ request()->segment(2) === 'driver-bookings' || request()->segment(2) === 'meeting-room-bookings' ? 'active open' : null }}">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->segment(2) === 'driver-bookings' ? 'active' : null }}">
                        <a href="{{ route('admin.driver-bookings.index') }}" class="menu-link">
                            <div data-i18n="Driver Booking">Driver Booking</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->segment(2) === 'meeting-room-bookings' ? 'active' : null }}">
            ...
            <li class="menu-item {{ request()->segment(2) === 'feedback-tags' ? 'active' : null }}">
