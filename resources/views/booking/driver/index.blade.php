...
<div class="card">
    <div class="card-body row justify-content-center g-4">
        ...
        <input type="text" class="form-control flatpickr" placeholder="Choose Date" value="{{ date('d M Y', strtotime(request()->year.'-'.request()->month.'-'.request()->day)) }}">
            ...
            <table class="table table-bordered text-nowrap">
                <thead>
                    ...
                    <tr>
                        ...
                        {{-- ✅ available slot --}}
                        @else
                        <td class="text-center hoverCell" style="cursor: pointer;">
                            <div data-bs-toggle="modal" data-bs-target="#bookingMeetingRoomModal"
