...
<head>
    <meta charset="UTF-8">
    <title>Meeting Room Booking Report</title>
    <style>
...
<body>
    <h2>Meeting Room Booking Report</h2>
    <div class="sub">
        Period:
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="9" style="text-align:center;padding:20px;color:#888">No data found.</td></tr>
            @endforelse
        </tbody>
    </table>
</body>
